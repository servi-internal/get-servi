...
const BULLETS = [
  "Single menu to manage",
  "Sales reporting all in one place",
  "Inventory automatically syncs",
  "Single payment processing account",
];
    ...
    <section className="py-10 bg-gray-50 dark:bg-zinc-950">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 min-w-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 lg:items-center">
          ...
          {/* Right — visual mockup */}
          <div className="flex justify-center lg:justify-end min-w-0 order-2 lg:order-2">
