      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 min-w-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
          ...
          <div className="space-y-4">
            ...
            {/* Easy to Use */}
            <div className="bg-white rounded-xl p-5 sm:p-6 border border-gray-100 border-l-4 border-l-[#FF6600] hover:shadow-lg transition-shadow">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl p-5 sm:p-6 border border-gray-100 border-l-4 border-l-gray-800 hover:shadow-lg transition-shadow">
              <div className="flex items-start gap-3 sm:gap-4">
