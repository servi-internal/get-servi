    ...
    <section className="py-24 bg-[#f8fafc]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16">
          {/* Comparison Table */}
          <div>
            <h3 className="text-2xl font-bold text-[#263238] mb-8 flex items-center gap-3">
              <span className="p-2 bg-[#ff7043]/10 rounded-lg text-[#ff7043]">
                <ArrowLeftRight className="w-6 h-6" />
              </span>
              Why Choose Ser.vi?
            </h3>
            <div className="bg-white rounded-2xl border border-[#e2e8f0] shadow-sm overflow-hidden">
              <div className="grid grid-cols-3 bg-[#263238] text-white p-4 items-center">
                <div className="col-span-1 font-bold text-sm">Feature</div>
                <div className="col-span-1 text-center font-bold text-[#ff7043] text-lg">
                  Ser.vi
                </div>
                <div className="col-span-1 text-center font-medium text-gray-400 text-sm">
                  Legacy POS
                </div>
              </div>
              <div className="grid grid-cols-3 p-4 border-b border-[#e2e8f0] hover:bg-gray-50 items-center">
                <div className="col-span-1 text-sm font-semibold text-[#263238]">
                  Monthly Software Cost
                </div>
                <div className="col-span-1 text-center font-black text-green-600 text-lg">
                  $0
                </div>
              ...
              <div className="grid grid-cols-3 p-4 border-b border-[#e2e8f0] hover:bg-gray-50 items-center">
                ...
                <div className="col-span-1 text-center text-sm font-bold text-[#263238]">
                  Any Device
                </div>
                <div className="col-span-1 text-center text-sm text-gray-500">
                  Proprietary
          ...
          <div>
            <h3 className="text-2xl font-bold text-[#263238] mb-8 flex items-center gap-3">
              <span className="p-2 bg-gray-100 rounded-lg text-[#263238]">
            ...
            <div className="space-y-4">
              {faqs.map((faq, index) => (
                ...
                >
                  <summary className="flex justify-between items-center p-5 cursor-pointer font-bold text-[#263238] hover:bg-gray-50 transition-colors list-none">
                    {faq.question}
