...
export function PricingCTA() {
  return (
    <section className="py-20 px-4">
      <div className="max-w-5xl mx-auto rounded-[2.5rem] bg-gradient-to-br from-[#FF6600] to-[#E65C00] p-8 md:p-16 text-center text-white relative overflow-hidden shadow-2xl shadow-orange-900/20">
        ...
        <div className="relative z-10">
          ...
          <div className="inline-block bg-white text-gray-900 px-10 py-8 rounded-3xl shadow-xl mb-10 transform hover:scale-105 transition-transform duration-300">
