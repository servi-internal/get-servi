...
export function SelfServiceHero() {
  return (
    <section className="relative py-16 lg:py-24 overflow-hidden">
      <div className="absolute top-0 right-0 -mr-20 -mt-20 w-[600px] h-[600px] bg-orange-50 dark:bg-orange-900/10 rounded-full blur-3xl opacity-60 pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-[400px] h-[400px] bg-gray-50 dark:bg-gray-800/50 rounded-full blur-3xl opacity-60 pointer-events-none"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative lg:h-[600px] flex items-center justify-center">
            <div className="relative w-full aspect-square max-w-[500px] flex items-center justify-center">
              <div className="absolute right-0 top-10 w-48 h-64 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 transform rotate-12 z-0 animate-float opacity-80">
              ...
              <div className="relative z-20 w-[260px] h-[520px] bg-gray-900 rounded-[3rem] border-8 border-gray-900 shadow-2xl overflow-hidden transform transition-transform hover:scale-105 duration-500">
              ...
              <div className="absolute bottom-20 -left-10 z-30 bg-white dark:bg-gray-800 p-4 rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-gray-100 dark:border-gray-700 flex items-center gap-4 animate-bounce max-w-[220px]">
