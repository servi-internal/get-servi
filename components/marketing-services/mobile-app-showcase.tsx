      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-1/2 order-2 lg:order-1 relative">
            <div className="relative w-[280px] h-[560px] rounded-[3rem] mx-auto overflow-hidden">
              <Image
            ...
            <div className="absolute top-1/2 -left-4 bg-white p-4 rounded-lg shadow-lg hidden md:block">
