        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
          <div className="flex flex-col gap-6 text-left">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <a href="#features" className="flex h-12 cursor-pointer items-center justify-center rounded-lg border border-gray-200 bg-white px-8 text-base font-bold text-[#333333] transition-all hover:bg-gray-50 hover:border-gray-300 hover:text-[#FF6600] scroll-smooth">
                Learn More
              </a>
            </div>
          </div>
