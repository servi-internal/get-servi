      ...
      <div className="mx-auto flex max-w-4xl flex-col items-center px-4 text-center">
        ...
        <div className="flex flex-col items-center gap-4 sm:flex-row">
          <a 
            ...
            className="flex h-14 min-w-[200px] cursor-pointer items-center justify-center rounded-lg bg-[#FF6600] px-8 text-lg font-bold text-white shadow-xl shadow-[#FF6600]/25 transition-transform hover:bg-[#FF6600]/90 hover:scale-105 active:scale-95"
          >
            Book a Meeting
          </a>
          <a 
            href="/pricing"
            className="flex h-14 min-w-[200px] cursor-pointer items-center justify-center rounded-lg border-2 border-gray-300 bg-white px-8 text-lg font-bold text-[#333333] transition-all hover:bg-gray-50 hover:border-[#FF6600]"
          >
            View Pricing
          </a>
        </div>
