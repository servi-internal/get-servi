    ...
    <section className="py-12 sm:py-16 lg:py-24 bg-[#f9fafb] dark:bg-[#18181b] text-center px-4 sm:px-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
          <button className="w-full sm:w-auto bg-[#ff6b00] text-white px-6 sm:px-8 py-3 sm:py-3.5 rounded-lg text-sm sm:text-base font-bold hover:bg-[#ff6b00]/90 transition-colors shadow-lg shadow-[#ff6b00]/20">
            Book a Meeting
          </button>
