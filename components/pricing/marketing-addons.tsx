    ...
    <section className="py-12 sm:py-16 lg:py-24 bg-[#f8fafc]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center mb-10 sm:mb-12 lg:mb-16 text-center">
          <span className="text-[#ff7043] font-bold tracking-wider uppercase text-xs sm:text-sm mb-2">
            Optional Add-ons
          </span>
          ...
          <div className="flex items-center bg-white p-1.5 rounded-full border border-[#e2e8f0] shadow-sm">
            <button
              ...
              className={`px-4 sm:px-6 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-bold transition-colors ${
        ...
        <div className="grid md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 border border-[#e2e8f0] hover:shadow-xl transition-all">
            <h3 className="text-base sm:text-lg font-bold text-[#263238]">Promote</h3>
            ...
            <button className="w-full py-2 sm:py-2.5 rounded-lg border-2 border-[#e2e8f0] text-[#263238] text-sm sm:text-base font-bold hover:border-[#ff7043] hover:text-[#ff7043] transition-colors">
              Select Plan
            </button>
          </div>

          {/* Grow & Retain Plan - Featured */}
          <div className="bg-white rounded-2xl p-6 sm:p-8 border-2 border-[#ff7043] shadow-xl relative transform md:-translate-y-4">
            ...
            <button className="w-full py-2.5 sm:py-3 rounded-lg bg-[#ff7043] text-white text-sm sm:text-base font-bold hover:bg-[#e64a19] transition-colors shadow-lg shadow-[#ff7043]/20">
              Start Free Trial
            </button>
          </div>
          ...
          {/* Enterprise Plan */}
          <div className="bg-white rounded-2xl p-6 sm:p-8 border border-[#e2e8f0] hover:shadow-xl transition-all">
            <h3 className="text-base sm:text-lg font-bold text-[#263238]">Enterprise</h3>
            <div className="mt-3 sm:mt-4 flex items-baseline gap-1">
              <span className="text-3xl sm:text-4xl font-black text-[#263238]">
                ${getPrice(749)}
              </span>
